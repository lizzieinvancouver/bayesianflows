...
\title{Supplement: A four-step simulation-based workflow for ecological analysis and science}
% \date{\today}
...
The three very simple examples shown in Fig. \ref{fig:twoexamples} are available at: \url{https://github.com/lizzieinvancouver/bayesianflowsexample/tree/main/casestudies}
