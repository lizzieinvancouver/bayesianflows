...
Now that we have a simulated dataset, we code the underlying model in Stan:
...
And then run it on the simulated data to check how well the model returns the parameters we set.
```{r}
