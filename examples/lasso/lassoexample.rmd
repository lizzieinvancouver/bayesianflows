---
title: |
 | <span style='font-size: 30px'>Short case study 2:
 | A widely applicable workflow
subtitle: Steps 1-2 using Lasso regression
pagetitle: A widely applicable workflow
---
...
wd <- '~/projects/bayesianflows/examples/lasso'
...
# Run cross-validated to get lambda and plot results (the number of predictor variables is shown on the top)
