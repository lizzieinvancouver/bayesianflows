...
Now we fit the lasso regression and look at what parameters it finds are most important. We simulated leafout based on GDD from temperature so we may expect metrics related to temperatures, especially the warmer ones that happen in the spring, should be important.
