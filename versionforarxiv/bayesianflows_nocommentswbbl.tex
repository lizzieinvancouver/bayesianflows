...
\bibitem[{Anderson \emph{et~al.}(2021)Anderson, Elsen, Hughes, Tonietto, Bletz,
...
\bibitem[{Beaumont(2019)}]{reid2019}
...
Betancourt, M. (2021{\natexlab{a}}) Prior modeling.
  \ur{https://betanalpha.github.io/assets/case_studies/prior_modeling.htmll}.
...
\bibitem[{Gabry \emph{et~al.}(2019)Gabry, Simpson, Vehtari, Betancourt \&
  Gelman}]{gabryvis}
...
\bibitem[{Gelman \emph{et~al.}(2000)Gelman, Goegebeur, Tuerlinckx \&
...
\bibitem[{Grinsztajn \emph{et~al.}(2021)Grinsztajn, Semenova, Margossian \&
  Riou}]{grinsztajn2021}
...
\bibitem[{Halsey \emph{et~al.}(2015)Halsey, Curran-Everett, Vowler \&
  Drummond}]{halsey2015}
...
\bibitem[{Hampton \emph{et~al.}(2013)Hampton, Strasser, Tewksbury, Gram,
...
\bibitem[{Held \emph{et~al.}(2010)Held, Schroedle \& Rue}]{held2010}
...
\bibitem[{Hoffman \& Gelman(2014)}]{nuts2014}
...
\bibitem[{Lemoine(2019)}]{lemoine2019}
...
\bibitem[{Muthukumarana \emph{et~al.}(2008)Muthukumarana, Schwarz \&
  Swartz}]{muthuku2008}
...
\bibitem[{Servedio \emph{et~al.}(2014)Servedio, Brandvain, Dhole, Fitzpatrick,
...
\bibitem[{Strinella \emph{et~al.}(2020)Strinella, Scridel, Brambilla, Schano \&
...
\bibitem[{Sunn{\aa}ker \emph{et~al.}(2013)Sunn{\aa}ker, Busetto, Numminen,
...
\bibitem[{Trijoulet \emph{et~al.}(2018)Trijoulet, Holmes \&
  Cook}]{trijoulet2018}
...
\bibitem[{van~de Schoot \emph{et~al.}(2021)van~de Schoot, Depaoli, King,
...
\bibitem[{Wesner \& Pomeranz(2021)}]{wesner2021}
...
\bibitem[{Winter \& Depaoli(2023)}]{winter2023}
...
\bibitem[{Zheng \emph{et~al.}(2007)Zheng, Ovaskainen, Saastamoinen \&
  Hanski}]{zheng2007}
